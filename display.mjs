...
export function assetsForView(assets, view='all') {
  if(view==='crypto') return assets.filter(asset=>asset.assetType==='Crypto');
  if(view==='stocks') return assets.filter(asset=>asset.assetType!=='Crypto');
  return assets;
}
